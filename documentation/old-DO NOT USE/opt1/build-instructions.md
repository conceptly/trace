...
**Fonts:** Load via `<link>` in `<head>`. ITC Avant Garde Gothic Pro is not on Google Fonts — use DM Sans as the exact fallback. Adelle is not on Google Fonts — use Source Serif 4 as fallback.

```html
<link rel="preconnect" href="https://fonts.googleapis.com">
<link href="https://fonts.googleapis.com/css2?family=DM+Sans:wght@300;400;500;600;700&family=Source+Serif+4:ital,wght@0,300;0,400;0,600;1,300&display=swap" rel="stylesheet">
```
...
:root {
  ...
  /* ── Backgrounds ── */
  --bg-base:              #223740;   /* Main dark background — all pages */
  --bg-card:              #375260;   /* Elevated cards, TopNav */
  --bg-card-glass:        rgba(55, 82, 96, 0.5);   /* Translucent card (map overlays) */
  ...
  --text-body:            #CDDBD0;   /* Body copy, secondary labels */
  --text-body-glass:      rgba(205, 219, 208, 0.5);
  --text-secondary:       #64858D;   /* Captions, metadata */

  /* ── CTA ── */
  --cta-default:          #E7E626;   /* Primary button fill */
  --cta-text:             #4A4D20;   /* Text ON yellow CTA button */
  --cta-secondary:        #507060;   /* Secondary button */
  --cta-hover:            #F0F040;   /* Primary button hover */
  --cta-pressed:          #C8C820;   /* Primary button pressed */
  --cta-disabled:         rgba(231, 230, 38, 0.3);

  /* ── Route colours ── */
  --route-typography:     #334A8E;   /* Typography route */
  --route-architecture:   #95452A;   /* Architecture route */
  --route-artifacts:      #3D8354;   /* Art Objects route */
  --route-streetart:      #742D7D;   /* Street Art / Murals route */
  --route-artist:         #0E6B70;   /* Artist's Pick route */

  /* Route pill: active background (at 50% opacity) */
  --route-typography-bg:  rgba(51,  74,  142, 0.5);
  --route-architecture-bg:rgba(149, 69,  42,  0.5);
  --route-artifacts-bg:   rgba(61,  131, 84,  0.5);
  --route-streetart-bg:   rgba(116, 45,  125, 0.5);
  --route-artist-bg:      rgba(14,  107, 112, 0.5);
  ...
  --font-display: 'ITC Avant Garde Gothic Pro', 'DM Sans', 'Century Gothic', sans-serif;
  --font-body:    'Adelle', 'Source Serif 4', Georgia, serif;
...
Font fallbacks: DM Sans for ITC Avant Garde Gothic Pro, Source Serif 4 for Adelle.
```
