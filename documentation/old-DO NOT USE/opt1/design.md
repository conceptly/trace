...
| Background Card | `bg-card` | `#375260` | Elevated card surfaces |
| Primary Elements | `text-emphasis` | `#EDF4F0` | H1–H3, icons, primary UI |
| Body Copy | `text-body` | `#CDDBD0` | Paragraph text |
| Secondary Elements | `text-secondary` | `#64858D` | Captions, metadata |
...
|---|---|---|
| Typography | `#334A8E` | Blue |
| Architecture | `#95452A` | Terracotta |
| Art Objects (Artifacts) | `#3D8354` | Forest green |
| Street Art (Murals) | `#742D7D` | Purple |
| Artist's Pick | `#0E6B70` | Dark teal |
